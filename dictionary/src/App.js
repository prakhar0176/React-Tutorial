...
function App() {
  ...
  return (
    <div className="App" style={{ height: '100vh', backgroundColor: LightMode ? '#fff' : '#282c34', color: LightMode ? 'Black' : 'white', transition: "all 0.5s linear" }}>
      <Container maxWidth="xl" style={{ display: 'flex', flexDirection: 'column', height: '100vh', justifyContent: 'space-evenly' }}>
        ...
        {meaning && (<Definitions word={word} meanings={meaning} category={category} LightMode={LightMode} />)}
      </Container>
    </div>
  );
}
